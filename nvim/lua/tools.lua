...
do
	...
	require("oil").setup({
		keymaps = { q = "actions.close", gq = "q", gd = { callback = _1_, desc = "Toggle file detail view" } },
	})
end
...
do
	...
	require("codecompanion").setup({
		...
		adapters = { http = { openrouter = openrouter } },
...
return vim.pack.add({ { src = "https://github.com/Olical/conjure" } })
