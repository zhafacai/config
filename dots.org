...
#+end_src
*** The =init.el= section about internal pacakges
...
(defmacro after! (features &rest body)
  ...
  (let ((fs (if (symbolp features)
    ...
    form))
#+end_src
*** The =zfc-macro.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-macro)
#+end_src
...
#+end_src
*** The =zfc-ui.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-ui)
#+end_src
...
#+end_src
*** The =zfc-base.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-base)
#+end_src
...
custom scripts with evil mappings
...
*** The =zfc-evil.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-evil)
#+end_src
...
*** The =zfc-org.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-org)
#+end_src
...
*** The =zfc-tool.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-tool)
#+end_src
...
*** The =zfc-lang.el= section for provide
#+begin_src emacs-lisp
(provide 'zfc-lang)
#+end_src
* Guix
