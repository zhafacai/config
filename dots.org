...
#+end_src
download fonts in android
#+begin_src shell
wget https://github.com/be5invis/Iosevka/releases/download/v34.8.1/PkgTTC-SGr-IosevkaFixedSS07-34.8.1.zip

wget https://github.com/be5invis/Iosevka/releases/download/v34.8.1/PkgTTC-SGr-IosevkaSlab-34.8.1.zip

wget https://github.com/be5invis/Iosevka/releases/download/v34.8.1/PkgTTC-SGr-IosevkaSS02-34.8.1.zip

wget https://github.com/be5invis/Iosevka/releases/download/v34.8.1/PkgTTC-SGr-IosevkaSS08-34.8.1.zip

wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/NerdFontsSymbolsOnly.zip

wget https://github.com/lxgw/LxgwMarkerGothic/releases/download/v1.003/LxgwMarkerGothic-v1.003.zip
#+end_src
#+begin_src emacs-lisp
...
*** The =zfc-dev.el= section about lisp development
#+begin_src emacs-lisp
(use-package eros
...
*** The =zfc-org.el= section about extra ui
#+begin_src emacs-lisp
...
#+end_src
*** The =art.scm= section about Network Manager
~sys-use~
#+begin_src scheme :noweb-ref sys-use
...
#+end_src
*** The =base.scm= section about GnuPG
~dev-use~
#+begin_src scheme :noweb-ref home-use
...
(service home-gpg-agent-service-type
         (home-gpg-agent-configuration
          ...
          (ssh-support? #t)))
#+end_src
*** The =dev.scm= section about environment variable
~dev-services~
#+begin_src scheme :noweb-ref dev-services
...
(service home-bash-service-type
		 (home-bash-configuration
		   ...
		   (bash-profile (list (local-file
								...
								"bash_profile")))))
#+end_src
*** COMMENT The =base.scm= section about open-ssh
~home-use~
#+begin_src scheme :noweb-ref home-use
