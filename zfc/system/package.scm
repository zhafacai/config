...
(define-public emacs-ewm
  (package
    (name "emacs-ewm")
    (properties '((commit . "e6aab4cda6cd3dee5de057e94edfcea015d164f0")))
    (version (git-version "0.1.0" "5" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "1pbw1bqar6jw6mdcp3bqc07rqhlkfng966mmczqnxb9ag2rrb03r"))))
